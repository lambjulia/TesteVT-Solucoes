...
<body>
    <form class="form-horizontal" method="post" action="{{ route('cartoes.update', $cartoes->id) }}">
        ...
        <div class="container-fluid" style="padding-left: 45em;padding-top: 3em">
            <div class="card" style="width: 30rem">
                ...
                <div class="card-footer text-muted">
                        ...
                        <a href="{{ route('funcionarios.ficha', ['id'=>$id]) }}" class="btn btn-secondary btn-sm"> Voltar para Ficha</a>
                </div>
